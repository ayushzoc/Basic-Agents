...
class SecurityCheck(BaseModel):
    ...
    is_safe: bool = Field(description="Whther the input appears safe")
...
async def validate_calendar_request(user_input: str) -> CalendarValidation:
    ...
    Args:
        user_input (str): Calendar request from the user.
...
async def validate_request(user_input: str) -> bool:
    ...
    Args:
        user_input (str): The input request from user.

    Returns:
        bool: Check if the request is valid or not.
    """
