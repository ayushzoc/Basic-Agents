...
class OrchestratorPlan(BaseModel):
    ...
    target_audience: str = Field(description="Intented audience for the blog")
...
class ReviewFeedback(BaseModel):
    ...
    final_version: str = Field(description="Complete, published blog post")


# Step 2: Define prompts
ORCHESTRATOR_PROMPT = """
Analyzie this blog topic and break it down into logical sections.
...
REVIEWER_PROMPT = """
Review this blog post for cohesion and flaw:
...
class BlogOrchestrator:
    ...
    def get_plan(self, topic: str, target_length: int, style: str) -> OrchestratorPlan:
        ...
        Args:
            topic (str): The topic of the blog
            target_length (int): The target word count
            style (str): The writing style of the blog
    ...
    def write_section(self, topic: str, section: SubTask) -> SectionContent:
        ...
        Args:
            topic (str): The topic of the blog
            section (SubTask): SubTask containing section details
    ...
    def review_post(self, topic: str, plan: OrchestratorPlan) -> ReviewFeedback:
        """Review: Analyze and improve overall cohesion.

        Args:
            topic (str): The main topic of the blog.
            plan (OrchestratorPlan): The plan to write the blog.

        Returns:
            ReviewFeedback: The cohesion, edits, and final version.
        """
        sections_text = "\n\n".join(
            [
                f"=== {section_type} ===\n{content.content}"
    ...
    def write_blog(
        ...
        Args:
            topic (str): The main topic of the blog.
            target_length (int, optional): The taget word count of the blog. Defaults to 1000.
            style (str, optional): The writing style of the blog. Defaults to "informative".
...
if __name__ == "__main__":
    ...
    # Technical blog post
    topic = "The impact of AI in software development"
    result = orchestrator.write_blog(
        topic=topic, target_length=1200, style="techincal but accessible"
    )
